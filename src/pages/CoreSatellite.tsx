...
export function CoreSatellite() {
  ...
  const donutData = useMemo(
    () => [
      { name: "Core", value: coreMV, color: "#64748b" },
      { name: "Satellite", value: satMV, color: "#d4af37" },
    ],
    [coreMV, satMV],
  );
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        <Card title="Sleeve mix">
          ...
          <div className="mt-4 space-y-2 text-sm">
            <SleeveRow label="Core" actual={coreActual} target={DEFAULT_CORE_TARGET} drift={coreDrift} color="#64748b" />
            <SleeveRow label="Satellite" actual={satActual} target={DEFAULT_SATELLITE_TARGET} drift={satDrift} color="#d4af37" />
          </div>
        </Card>
