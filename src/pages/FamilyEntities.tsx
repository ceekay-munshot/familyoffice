          ...
          <div className="mt-5 grid gap-5 lg:grid-cols-3">
              ...
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={stackedData} margin={{ top: 8, right: 8, left: -8, bottom: 0 }}>
                    ...
                    <XAxis dataKey="member" stroke="#64748b" fontSize={10} interval={0} angle={-12} textAnchor="end" height={48} />
            ...
            <Card title="In-house vs advisor" subtitle="Who manages the capital — and the return each is delivering">
              ...
              <div className="mt-3 space-y-2 text-sm">
                {[
                  { label: "In-house", b: inhouse, color: "#64748b" },
                  { label: "Advisor", b: advisor, color: "#d4af37" },
                ].map(({ label, b, color }) => (
            ...
            <div className="grid gap-5 lg:grid-cols-2">
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    <CartesianGrid stroke="#1e293b" strokeDasharray="2 4" vertical={false} />
                    <XAxis dataKey="bucket" stroke="#64748b" fontSize={10} interval={0} angle={-20} textAnchor="end" />
                    <YAxis stroke="#64748b" fontSize={11} tickFormatter={(v) => `${v}%`} />
                    <Tooltip
                    ...
                    />
                    <Bar dataKey="Target" fill="#1e293b" radius={[3, 3, 0, 0]} />
                    <Bar dataKey="Actual" fill="#d4af37" radius={[3, 3, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
