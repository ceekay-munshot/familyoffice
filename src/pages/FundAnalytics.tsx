        ...
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart margin={{ top: 8, right: 16, left: -8, bottom: 8 }}>
              ...
              <XAxis type="number" dataKey="x" name="Volatility" unit="%" stroke="#64748b" fontSize={11} domain={["dataMin - 1", "dataMax + 1"]} label={{ value: "Volatility (σ, %)", position: "insideBottom", offset: -4, fill: "#64748b", fontSize: 11 }} />
              <YAxis type="number" dataKey="y" name="3Y return" unit="%" stroke="#64748b" fontSize={11} domain={["dataMin - 2", "dataMax + 2"]} />
              ...
              {Object.entries(scatterByVehicle).map(([v, data]) => (
                <Scatter key={v} name={v} data={data} fill={VEHICLE_COLOR[v] ?? "#64748b"} fillOpacity={0.8} />
              ))}
            </ScatterChart>
          </ResponsiveContainer>
        </div>
