        ...
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={top10} margin={{ top: 8, right: 8, left: -8, bottom: 0 }}>
              ...
              <XAxis dataKey="ticker" stroke="#64748b" fontSize={10} interval={0} angle={-25} textAnchor="end" height={50} />
              <YAxis stroke="#64748b" fontSize={11} tickFormatter={(v: number) => fmtFromBase(v, { compact: true })} />
              <Tooltip
              ...
              />
              <Bar dataKey="Direct" stackId="x" fill="#d4af37" radius={[0, 0, 0, 0]} />
              <Bar dataKey="Via funds" stackId="x" fill="#3b82f6" radius={[3, 3, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </Card>
