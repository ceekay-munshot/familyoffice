...
const PALETTE = [
  "#d4af37", "#3b82f6", "#10b981", "#a855f7", "#f97316", "#ef4444",
  "#06b6d4", "#84cc16", "#ec4899", "#facc15", "#8b5cf6", "#64748b",
];
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={compareBars} margin={{ top: 8, right: 8, left: -8, bottom: 32 }}>
                ...
                />
                <Bar dataKey="NIFTY 500" fill="#1e293b" radius={[3, 3, 0, 0]} />
                <Bar dataKey="Portfolio" fill="#d4af37" radius={[3, 3, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
